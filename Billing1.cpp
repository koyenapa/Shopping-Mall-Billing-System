...
m:
    ...
    case 1:
        ...
        if(email=="koyenapaul023@gmail.com" && password=="koyenapaul")
        {
            administrator();
        }
        else
...
void shopping::receipt()
{
    ...
    if(!data)
    {
        ...
        do
        {
            ...
            c++;
            cout<<"\n\n Do you want to buy another product? if yes then press y else press n for no : ";
            cin>>choice;
        }
        while(choice=='y');
